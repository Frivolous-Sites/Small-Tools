...
about() {
	...
	echo " ========================================================= "
	echo ""
	echo " Intro: https://t69.us/?www.oldking.net/350.html"
	echo ""
}
...
print_system_info() {
	echo -e " IP Address           : ${YELLOW}`curl -s https://picloud.xyz/?IP_ONLY`${PLAIN}" | tee -a $log
...
print_intro() {
	printf ' Superbench.sh -- https://t69.us/?www.oldking.net/350.html\n' | tee -a $log
